install_oracle_libraries(){
  ...
  cd $build_dir/oracle
  local basic_download_url="https://github.com/bumpx/oracle-instantclient/instantclient-basiclite-linux-x86-64-11.2.0.2.0.zip"
  local sdk_download_url="https://github.com/bumpx/oracle-instantclient/instantclient-sdk-linux.x64-12.2.0.1.0.zip"
